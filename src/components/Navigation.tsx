      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex-shrink-0">
            <h1 className="text-3xl relative top-2.5 font-bold gradient-text cursor-pointer" onClick={() => { window.location.href = '/' }}>Muthu <span className="text-royal-500">Hariharan</span></h1>
          </div>
